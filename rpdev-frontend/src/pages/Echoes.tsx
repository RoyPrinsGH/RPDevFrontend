            ...
            <div className='page p-4 bg-blue-950 h-full w-full'>
                ...
                <div className="content text-center">
                    <div className="flex flex-col" style={{"gap" : isPlayingAudio ? "2rem" : "6rem", "transition": "gap 2s ease"}}>
                        ...
                        <div className="belowbutton" style={{"height" : "816px"}}>
                            <div className="lyrics text-white font-thin absolute left-0 right-0 m-4" style={{"transition": "opacity 2s linear", "opacity": isPlayingAudio ? 1 : 0}}>
